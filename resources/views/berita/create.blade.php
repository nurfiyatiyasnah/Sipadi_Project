...
<div class="mx-auto max-w-[1180px] space-y-8">
    ...
    <section class="flex flex-wrap items-center justify-between gap-4">
        <div>
            ...
            <h2 class="mt-2 font-serif text-3xl font-bold text-[#071426]">Tambah Berita Baru</h2>
            <p class="mt-1 text-slate-500">Tulis konten berita baru untuk perpustakaan SIPADI.</p>
        </div>
    </section>
    ...
    <form method="POST" action="{{ route('petugas.berita.store') }}" enctype="multipart/form-data">
        @csrf
        <div class="grid gap-8 xl:grid-cols-[1fr_380px]">
            ...
            <div class="space-y-6">
                ...
                {{-- Action Buttons --}}
                <div class="rounded-3xl bg-white p-6 shadow-sm">
                    <p class="mb-4 text-sm font-bold uppercase tracking-widest text-slate-600">Publikasi</p>
                    <div class="space-y-3">
                        <button type="submit" name="status_berita" value="terbit"
                        ...
                        <button type="submit" name="status_berita" value="draft"
